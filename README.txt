...
* Add more CNN layers ([see discussion](https://github.com/githubharald/Handwriting-Recognition-using-machine-learning/issues/38)).
* Replace LSTM by 2D-LSTM.
* Replace optimizer: Adam improves the accuracy, however, the number of training epochs increases ([see discussion](https://github.com/githubharald/Handwriting-Recognition-using-machine-learning/issues/27)).
